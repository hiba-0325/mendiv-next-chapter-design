      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Premium science-backed wellness programs that measure first, then
            create your personalized path to optimal health and longevity.
          </p>

          {/* Glassmorphic CTA Panel */}
          <div className="glass-card max-w-lg mx-auto">
            <div className="space-y-4">
              <Button size="lg" className="w-full animate-glow text-lg py-6">
          ...
          <div
            className="absolute -bottom-10 -left-10 w-32 h-32 bg-secondary/10 rounded-full blur-xl animate-float"
